...
<!-- End Google Tag Manager (noscript) -->
   ...
   <div id="wb_Form1" >
      <form name="Form1" method="post" action="<?php echo basename(__FILE__); ?>" enctype="multipart/form-data" accept-charset="UTF-8" id="Form1">
		 ...
		 <div id="wb_Text1" >
            <span ><strong>ЗАКАЗАТЬ КЛАПАНЫ</strong></span></div>
			...
			<div class="form-wrap-but">
				 ...
				 <div id="wb_Shape3" >
					<a href="./page2.php"><img src="images/img0035.png" id="Shape3" alt="" ></a></div>
				
				<div id="wb_Shape2" >
					<a href="javascript:history.back()" onclick="ShowObject('wb_Text3', 1);ShowObject('wb_Text4', 0);ShowObject('Layer2', 1);return false;">
					<img src="images/img0036.png" id="Shape2" alt="" ></a></div>
				 <input type="submit" id="Button1" onmouseover="ShowObject('Image6', 0);return false;" onmouseout="ShowObject('Image6', 1);return false;" name="" value="Оставить заявку" class="style1">
				
				 <div id="Layer2" >
					<div id="wb_Shape1" >
					   <a href="#" onclick="ShowObject('Layer2', 0);ShowObject('wb_Text4', 1);ShowObject('wb_Text3', 0);return false;">
					   <img src="images/img0037.png" id="Shape1" alt="" ></a></div>
				 </div>
         ...
         <input type="hidden" name="ЗАКАЗАТЬ клапаны" value="">
		 ...
		 <div class="checkbox-text">
			...
			<a href="javascript:popupwnd('Politika.pdf','no','no','no','no','no','no','','0','800','750')" target="_self">Согласен(а) с Политикой конфиденциальности.</a></span></div>
