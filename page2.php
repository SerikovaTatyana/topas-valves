...
@media only screen and (max-width: 400px) {
   ...
   <div id="wb_Form1" >
      <form name="Form1" method="post" action="<?php echo basename(__FILE__); ?>" enctype="multipart/form-data" accept-charset="UTF-8" id="Form1">
		 ...
		 <div id="wb_Text1" >
		  <span ><strong>Узнать подробную информацию <br>с консультацией</strong></span>
	   </div>
		...
		<div class="form-text">
         ...
         <div id="Layer2" >
            <div id="wb_Shape1" >
			   ...
			   <img src="images/img0026.png" id="Shape1" alt="" ></a></div>
         </div>
         ...
         <input type="hidden" name="УЗНАТЬ ХАРАКТЕРИСТИКИ (ручные)" value="">
