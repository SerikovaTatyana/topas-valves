...
<!-- End Google Tag Manager (noscript) -->
   ...
   <div id="wb_Form1" style="position:absolute;left:0px;top:15px;width:356px;height:282px;z-index:13;">
      <form name="Form1" method="post" action="<?php echo basename(__FILE__); ?>" enctype="multipart/form-data" accept-charset="UTF-8" id="Form1">
         ...
         <input type="hidden" name="УЗНАТЬ О КОМПАНИИ" value="">
         <div id="wb_Text2" style="position:absolute;left:31px;top:240px;width:297px;height:28px;text-align:center;z-index:1;">
            <span style="color:#000000;">Данные используются только для обратной связи, не подлежат обработке.</span></div>
         <div id="wb_Shape3" style="position:absolute;left:189px;top:148px;width:140px;height:50px;z-index:2;">
            <a href="./page2.php"><img src="images/img0041.png" id="Shape3" alt="" style="width:140px;height:50px;"></a></div>
         <div id="wb_Shape2" style="position:absolute;left:31px;top:148px;width:140px;height:50px;z-index:3;">
            <a href="javascript:history.back()" onclick="ShowObject('wb_Text3', 1);ShowObject('wb_Text4', 0);ShowObject('Layer2', 1);return false;"><img src="images/img0042.png" id="Shape2" alt="" style="width:140px;height:50px;"></a></div>
         <input type="submit" id="Button1" onmouseover="ShowObject('Image6', 0);return false;" onmouseout="ShowObject('Image6', 1);return false;" name="" value="Оставить заявку" class="style1" style="position:absolute;left:189px;top:151px;width:140px;height:56px;z-index:4;">
         <div id="wb_Text4" style="position:absolute;left:30px;top:51px;width:297px;height:23px;visibility:hidden;text-align:center;z-index:5;">
            <span style="color:#000000;font-family:'Roboto Condensed';font-weight:300;font-size:19px;">Это точно Ваш телефон?</span></div>
         <div id="wb_Text3" style="position:absolute;left:0px;top:54px;width:356px;height:19px;visibility:hidden;text-align:center;z-index:6;">
            <span style="color:#000000;font-family:'Roboto Condensed';font-weight:300;font-size:16px;">Введите верный номер телефона</span></div>
         <div id="Layer2" style="position:absolute;text-align:left;left:14px;top:142px;width:330px;height:68px;z-index:7;">
            <div id="wb_Shape1" style="position:absolute;left:18px;top:3px;width:297px;height:56px;z-index:0;">
               <a href="#" onclick="ShowObject('Layer2', 0);ShowObject('wb_Text4', 1);ShowObject('wb_Text3', 0);return false;"><img src="images/img0043.png" id="Shape1" alt="" style="width:297px;height:56px;"></a></div>
         </div>
         <input type="tel" id="phone" style="position:absolute;left:33px;top:81px;width:282px;height:44px;z-index:8;" name="Tel_" value="" spellcheck="false" placeholder="+7(___) ___-__-__" $.fn.inputmasks="function(maskOpts," mode)="">
         <input type="checkbox" id="Checkbox1" name="Checkbox1" value="on" checked style="position:absolute;left:32px;top:209px;z-index:9;" required>
         <div id="wb_Text5" style="position:absolute;left:58px;top:212px;width:287px;height:14px;z-index:10;" display:="" none="">
         ...
         <div id="wb_Text1" style="position:absolute;left:0px;top:3px;width:356px;height:35px;text-align:center;z-index:11;">
            <span style="color:#3C2415;font-family:'Roboto Condensed';font-size:29px;"><strong>УЗНАТЬ О КОМПАНИИ</strong></span></div>
      </form>
   </div>
   <script>   
