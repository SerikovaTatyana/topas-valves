...
<link href="css/Zakazat1.css" rel="stylesheet" type="text/css">
...
<!-- End Google Tag Manager (noscript) -->
   ...
   <div id="wb_Form1" >
      <form name="Form1" method="post" action="<?php echo basename(__FILE__); ?>" enctype="multipart/form-data" accept-charset="UTF-8" id="Form1">
			...
			<div id="wb_Text1" >
            <span><strong>ЗАКАЗАТЬ ЗВОНОК</strong></span></div>
			...
			<div class="form-wrap-but">
				 ...
				 <div id="Layer2">
					<div id="wb_Shape1">
					   ...
					   <img src="images/img0034.png" id="Shape1" alt=""></a></div>
				 </div>
         ...
         <input type="hidden" name="ЗАКАЗАТЬ ЗВОНОК" value="">
